...
export const personalProjects: PersonalProject[] = [
  {
    ...
    status: 'DONE',
    kind: 'Tool',
    tech: ['Java', 'Maven', 'JUnit', 'TypeScript', 'React', 'Vite', 'Tailwind CSS', 'Docker'],
  ...
  },
  {
    ...
    status: 'DONE',
    kind: 'Tool',
    tech: ['Java', 'Gradle', 'JUnit', 'Jackson'],
    ...
    images: [
      ...
      'images/projects/interactive-log-masking-cli/03.webp',
      'images/projects/interactive-log-masking-cli/04.webp',
      'images/projects/interactive-log-masking-cli/05.webp',
    ],
    featured: false,
    updatedAt: '2026-1-6',
  },
  ...
  },
  {
    ...
    status: 'DONE',
    kind: 'Web App',
    tech: ['JavaScript', 'React', 'Vite', 'Tailwind CSS', 'Node.js', 'Express', 'PostgreSQL'],
  ...
  },
  {
    ...
    status: 'DONE',
    kind: 'Game',
    tech: ['TypeScript', 'Vite', 'Tailwind CSS', 'HTML'],
  ...
  },
  {
    ...
    status: 'DONE',
    kind: 'Web App',
    tech: ['TypeScript', 'Next.js', 'React', 'Tailwind CSS', 'Prisma'],
  ...
  },
  {
    ...
    description:
      ...
      '現在閲覧しているこのポートフォリオサイト自体についてまとめた項目。',
    features: [
      ...
      'Kind / Tech によるフィルター機能',
      'ライト / ダーク / システム設定に対応したテーマ切り替え',
    ...
    images: [
      ...
      'images/projects/portfolio/04.webp',
    ],
    featured: false,
    updatedAt: '',
  },
